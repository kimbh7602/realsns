                ...
                <div v-if="isLocationSelect" class="row form-group mb-5">
                    ...
                    <div class="row form-group mb-5 justify-content-center">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="javascript:void(0)" style="margin-right:0px;margin-left:10px;padding-right:0px;padding-left:0px;" @click="dist=0.01; distString='1 Km'">1 Km</a>
                            <a class="dropdown-item" href="javascript:void(0)" style="margin-right:0px;margin-left:10px;padding-right:0px;padding-left:0px;" @click="dist=0.005; distString='500 m'">500 m</a>
                            <a class="dropdown-item" href="javascript:void(0)" style="margin-right:0px;margin-left:10px;padding-right:0px;padding-left:0px;" @click="dist=0.003; distString='300 m'">300 m</a>
                        </div>
