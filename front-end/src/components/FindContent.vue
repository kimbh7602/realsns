        ...
        <div class="row justify-content-center">
            <div class="col-md-8 pt-4">
                ...
                <div v-if="isLocationSelect" class="row form-group mb-5">
                    ...
                    <input @click="isLocation = true; isLocationSelect=false; dist=0.01; distString='1 Km'; searchKeyword=''; contents=null" type="button" value="다시 위치검색" class="btn btn-outline-warning btn-block">
      ...
      http
        ...
        .then((res) => {
          for (var i = 0; i < res.data.resvalue.length; i++) {
            ...
            this.userLikeList.push(res.data.resvalue[i].content_id)
          }
        })
        .catch(()=>{
          this.errored = true;
